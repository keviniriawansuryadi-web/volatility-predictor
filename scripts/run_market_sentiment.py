...
print(f"\n{'='*65}")
print("  SECTION 9 — MARKET SENTIMENT INDEX")
print(f"{'='*65}")
...
# ── Summary ──────────────────────────────────────────────────────────────────
print(f"\n{'='*65}")
print("  H1 TEST COMPARISON — INDIVIDUAL vs MARKET-WIDE SENTIMENT")
print(f"{'='*65}")
print("  Individual SPY sentiment H1  : p=0.1440 (from prior run — NOT significant)")
...
if h1_result.get("significant") or h1_eq.get("significant"):
    ...
    print("  RECOMMENDATION: Add market_sentiment_index as a feature to SPY models.")
else:
    print("\n  Market-wide sentiment does NOT improve H1 test on SPY.")
    print("  Sentiment signal remains stock-specific, not market-wide.")
